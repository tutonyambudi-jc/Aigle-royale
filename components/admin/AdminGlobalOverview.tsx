...
export function AdminGlobalOverview({ overview }: Props) {
  ...
  const [coreGroup, ...secondaryGroups] = groups
  ...
  return (
    <section className="mb-10">
      ...
      <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-5">
        <div
          key={coreGroup.title}
          className={`rounded-2xl border border-gray-200 shadow-sm overflow-hidden border-l-4 ${coreGroup.accent}`}
        >
          <div className="px-5 py-3 border-b border-gray-100 bg-white/70">
            <h3 className="font-bold text-gray-900 text-sm">{coreGroup.title}</h3>
          </div>
      ...
      <div className="mt-10 pt-8 border-t border-gray-200">
        <h3 className="text-lg font-bold text-gray-900">Modules secondaires</h3>
        <p className="text-sm text-gray-600 mt-1 mb-5">
          Réseau & arrêts, chauffeurs, fidélité, notifications, support, publicité et autres espaces transverses.
        </p>
        <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-5">
